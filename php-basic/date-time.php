...
<body>
  <P>
    <?php
    //使用するデフォルトのタイムゾンを指定する
    date_default_timezone_set('Asia/Tokyo');

    //現在の日時を、指定したフォーマットで出力する
  ...
  <p>
    <?php
    //加算・減算してもインスタンス$加算・減算してもインスタンス$nowの日時が変わらないように、DateTimeImmutableクラスを使って作成する
    ...
    echo $sub->format('現在から3日後はY年n月j日H時i分s秒です。');
    ?>
  </p>
</body>
</html>